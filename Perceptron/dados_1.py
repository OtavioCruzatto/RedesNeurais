...
def dados_1():
    ...
    x_classificar = [[-0.3665, 0.0620, 5.9891],
    ...
    nn = Perceptron(0.01, 600, 3)
    nn.exibir_dados_da_rede()
    nn.treinar(x_treino, y_treino)
    nn.exibir_dados_da_rede()
    y_classificado = nn.classificar(x_classificar, classe_a="P1", classe_b="P2")
